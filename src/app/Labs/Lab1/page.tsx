  ...
  return (
    <div id="wd-lab1">
      ...
      <div id="wd-lists">
        ...
        <p>My favorite recipe: Overnight Oats</p>
        <ol id="wd-your-favorite-recipe">
          <li>Pour 40 grams of quick oats in a mason jar.</li>
          <li>Pour 2 scoops of chocolate protein powder.</li>
          <li>Pour 160ml of almond milk in the jar.</li>
          <li>Scoop one tablespoon of chia seeds.</li>
          <li>Seal lid shut and shake for proper mixture.</li>
          <li>
            Once fully mixed, store in fridge overnight or for a minimum of 2
            hours.
          </li>
          <li>Grab a spoon and enjoy chilled :p</li>
        </ol>
