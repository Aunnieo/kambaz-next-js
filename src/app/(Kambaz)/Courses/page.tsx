...
const courses = [
  { cid: "1234", title: "CS1234 React JS", subtitle: "Full Stack Software Developer" },
  ...
  { cid: "DiscreteMaths", title: "MATH 2301", subtitle: "Discrete Mathematics" },
...
export default function CoursesPage() {
  return (
    <div className="p-3">
      ...
      <ListGroup>
        {courses.map((course) => (
          <Link key={course.cid} href={`/Course/${course.cid}/Home`} className="text-decoration-none">
